...
class BaseOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--dataroot', type=str, required=False, help='path of data')
        self.parser.add_argument('--img_size', type=int, default=96, help='resized image size for training')
        self.parser.add_argument('--nz', type=int, default=200, help='dimensions of z')
        self.parser.add_argument('--class_num', type=int, default=10, help='class number of the dataset')
        self.parser.add_argument('--real_z', type=int, default=100, help='dimensions of z')
...
class TrainOptions(BaseOptions):
    def __init__(self):
        ...
        #ouptput related
        self.parser.add_argument('--name', type=str, default='trial_uni', help='folder name to save outputs')
...
class TestOptions(BaseOptions):
    def __init__(self):
        ...
        self.parser.add_argument('--name', type=str, default='STL10', help='folder name to save outputs')
        self.parser.add_argument('--result_dir', type=str, default='./results', help='path for saving result images and models')

        # model related
        self.parser.add_argument('--resume', type=str, required=False, help='specified the dir of saved models for resume the training')
        self.parser.add_argument('--gpu', type=int, default=0, help='gpu')
