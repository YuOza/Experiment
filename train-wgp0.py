...
def main(nz, real_z, n_ep, m_name, dataset_name, value, space):
    ...
    for ep in range(ep0, opts.n_ep):
        ...
        if ep % space == 0 and ep != 0:
            if highest_loss < discriminator_losses[ep]: # 最良が更新された
                highest_z = model.real_z
                highest_loss = discriminator_losses[ep]
    ...
    for i in discriminator_losses:
        #print(i)
        log.write(str(i) + '\n')
    print('Convergence score print')
    for i in convergence_score:
        print(i)
