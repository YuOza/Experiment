...
def main(n_ep, img_size):
    ...
    path = pathlib.Path('/home/yuu/Desktop/new_experiments/learn/test_models')
    ...
    for model_path in models:
        ...
        model_name = str(model_path)[52 : m.end()-1]
        print(model_name)
        
        result_dir = '/home/yuu/Desktop/new_experiments/generated_image/LSUN_' + dataset + '/' + model_name
        if dataset == 'Celeb':
            result_dir = '/home/yuu/Desktop/new_experiments/generated_image/' + dataset + '/' + model_name
